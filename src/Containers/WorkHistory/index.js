    ...
    return(
        <div id="resume" className="workHistoryWrapper">
            <div className="workHistoryContainer">
                <Router>
                    <h2><i className="fas fa-anchor"></i> Resume <a href="https://docs.google.com/document/d/1phvYOdsT17Tdzh2zl9s8xB5ZxXSd2c3BRG21pNyGv7o/edit?usp=sharing" target="_blank"><i class="fas fa-file-download"></i></a></h2>
